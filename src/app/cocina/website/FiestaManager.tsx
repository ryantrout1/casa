                        ...
                        <div style={{ display: "grid", gap: 10, padding: "6px 2px 12px" }}>
                          ...
                          >
                            <PlateControls
                              ...
                              disabled={busyId === r.id}
                              onChange={(patch) => {
                                if (patch.plateUrl !== undefined)
                                  setField("heroPlateUrl", patch.plateUrl);
                                if (patch.plateMobileUrl !== undefined)
                                  setField("heroPlateMobileUrl", patch.plateMobileUrl);
                                if (patch.plateFocus !== undefined)
                                  setField("heroPlateFocus", patch.plateFocus);
                              }}
                              onError={setErr}
                            />
                          </div>
